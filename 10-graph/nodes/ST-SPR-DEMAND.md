...
edges:
  - to: OUT-OIL-PRICE
    ...
    lag_months: [4, 18]
    confidence: 0.7
    mechanism: "供給增加與需求減少同時作用（需求破壞需時累積）"
  ...
  - to: OUT-EU-GAS-PRICE
    ...
    lag_months: [6, 24]
    confidence: 0.65
    mechanism: "工業減產與家庭節能降低用氣（行為調整需時）"
...
|---|---|---|---|---|---|---|
| [[OUT-OIL-PRICE]] | 抑制 ↓ | 4–18 | 0.7 | 供給增加與需求減少同時作用（需求破壞需時累積） | 已實現 — 2022H2 油價回落 | 儲備耗盡且需求剛性 |
| [[OUT-EU-GAS-PRICE]] | 抑制 ↓ | 6–24 | 0.65 | 工業減產與家庭節能降低用氣（行為調整需時） | 已實現 — 歐洲工業用氣顯著下降 | 需求無彈性 |
