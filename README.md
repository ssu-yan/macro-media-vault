...
| `10-graph/G3-每週掃描協議-mirror-v3.6.md` | **G3 協議鏡像**（權威在 claude.ai Project，此為版控備份）→ 見下 |
...
`claude/G3-每週掃描協議.md`（現為 v3.6）——雲端排程 session 沒有裝置橋接、讀不到 vault，
所以那份必須自足。**要改規則，改那裡。**

但 Project 上的檔案沒有版本控制、沒有備份、沒有 diff，2026-08-25 曾被一份舊草稿整份覆蓋。
因此 `10-graph/G3-每週掃描協議-mirror-v3.6.md` 是納入 Git 的鏡像備份。
